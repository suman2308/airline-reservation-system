    ...
    <div class="container">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
            <div class="text-start">
                <h1 class="mb-1"><i class="bi bi-bell me-2 text-accent"></i>Notifications</h1>
                <p class="mb-0">Stay updated with your bookings and account activity</p>
            </div>
            <?php if ($unreadCount > 0): ?>
            <a href="?mark_all_read=1" class="btn btn-outline-accent btn-sm"><i class="bi bi-check2-all me-1"></i>Mark All Read</a>
            <?php endif; ?>
        </div>
    </div>
</div>
