...
<div class="container py-5">
    ...
    <h3 class="mt-5 mb-3"><i class="bi bi-airplane me-2 text-accent"></i>All Available Flights</h3>
    <?php
    $stmt = mysqli_prepare($conn, "SELECT * FROM flights WHERE status='Scheduled' AND seats_available > 0 ORDER BY departure_time ASC");
    ...
    <div class="flight-card">
        <div class="row align-items-center">
            ...
            <div class="col-md-2 text-end">
                <a href="<?php echo BASE_URL; ?>flight-details.php?id=<?php echo $f['flight_id']; ?>" class="btn btn-accent w-100">View Details</a>
            </div>
        </div>
    </div>
