...
<div class="container py-5 text-center" style="min-height: 60vh;">
    <div class="row justify-content-center align-items-center h-100">
        <div class="col-md-6">
            <i class="bi bi-exclamation-triangle text-warning display-1 mb-4 d-block" style="opacity:0.3;"></i>
            <h1 class="display-4 fw-bold mb-3">500</h1>
            <h3 class="fw-bold mb-3">Something Went Wrong</h3>
            <p class="text-muted lead mb-4">We encountered an unexpected error. Our team has been notified.</p>
